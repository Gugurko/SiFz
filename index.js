...
/////////////////
const BotName = 'SiFz BOT☄'; 
const instagram = 'https://instagram.com/xgame.sanz'; 
const telegram = 'gak punya :-)'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://youtube.com/channel/UCH5A7ZhfF5eIEjWzLzIRHaA';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@xgame.sanz')
